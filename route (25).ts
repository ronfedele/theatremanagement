  ...
  return (
    <div>
      ...
      {filtered.length === 0 ? (
        ...
        <div className='table-scroll' style={{ border:'1px solid rgba(201,168,76,.12)', borderRadius:3, overflow:'hidden' }}>
                ...
                <div style={{ padding:'1.3rem', background:'#282014' }}>
                  ...
                  {activeTab === 'photos' && (
                    <div>
                      ...
                      <div className='photo-grid' style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(150px,1fr))', gap:'.8rem', marginBottom:'1rem' }}>

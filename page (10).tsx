...
export default function LoginPage() {
  ...
  return (
    <div style={{minHeight:'100vh',background:'radial-gradient(ellipse at 25% 35%,#2e2410 0%,#201c10 65%)',display:'flex',alignItems:'center',justifyContent:'center',padding:'1rem',paddingTop:'2rem',paddingBottom:'2rem'}}>
      <div style={{width:'100%',maxWidth:'min(420px, calc(100vw - 2rem))',background:'linear-gradient(145deg,#2e2618,#252018)',border:'1px solid rgba(201,168,76,.4)',borderRadius:4,padding:'2.5rem',position:'relative',boxShadow:'0 28px 70px rgba(0,0,0,.7)'}}>
